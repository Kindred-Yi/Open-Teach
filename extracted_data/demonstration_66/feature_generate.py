...
def main():
    ...
    with h5py.File(INPUT_FILE, 'r') as f:
        ...
        # 位置 (N, 3)
        pos_R = f['right_gripper']['wrist_positions'][:]
        pos_L = f['left_gripper']['wrist_positions'][:]
        
        # 方向 (N, 4)
        ori_R = f['right_gripper']['wrist_orientations'][:]
        ori_L = f['left_gripper']['wrist_orientations'][:]
