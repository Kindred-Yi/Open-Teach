...
# === 配置 ===
JSON_PATH = "project-1-at-2025-11-26-00-07-4f444134.json"  # 你的 Label Studio 导出文件
H5_PATH = "aligned_data.h5"     # 之前对齐好的 H5 文件
TOTAL_FRAMES = 5061             # 视频总帧数 (根据你之前的描述)

# 定义类别映射 (String -> ID)
# 建议：No Action 设为 0，其他任意
LABEL_MAPPING = {
    "No Action (无动作)": 0,
    "Loosely Coupled (松散/弱相关)": 1,
    "Unimanual Left (左单手)": 2,
    "Unimanual Right (右单手)": 3,
    "Tightly Asym (L-Dom) (紧密-左主导)": 4,
    "Tightly Asym (R-Dom) (紧密-右主导)": 5
}
